...
function SearchCategory({ allCategories }) {
    ...
    return (
        <div className='w-1/2 flex flex-col items-center min-h-[140px] mx-auto mt-2 border rounded-md overflow-hidden border-blue-400'>
            ...
            <div className='p-2 px-6 mt-2 flex justify-between flex-wrap'>
